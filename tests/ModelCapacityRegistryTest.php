...
assertEq(32_000,  ModelCapacityRegistry::get('mistral-small'), 'mistral-small exact');
...
assertEq(2_000_000, ModelCapacityRegistry::get('gemini-3.1-pro-preview'), 'gemini 3.1 pro = 2M');
...
assertEq(128_000,   ModelCapacityRegistry::get('mistral-medium-latest'), 'mistral-medium-latest = 128k');
...
assertEq(128_000, ModelCapacityRegistry::get('mistral-large-latest'),'mistral-large-latest prefix match');
assertEq(32_000,  ModelCapacityRegistry::get('mistral-small-latest'),'mistral-small-latest prefix match');
